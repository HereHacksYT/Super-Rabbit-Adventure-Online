...
const roofMat = new THREE.MeshStandardMaterial({ color: 0x8B4513, roughness: 0.6 }); // çatı düz renk kalsın

// --- ZEMİN ---
const groundGeo = new THREE.CircleGeometry(120, 128);
const ground = new THREE.Mesh(groundGeo, grassMat.clone());
