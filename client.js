...
function createRabbitStatue() {
    ...
    const bm = new THREE.MeshStandardMaterial({ color: 0xdddddd });
    
    const body = new THREE.Mesh(new THREE.BoxGeometry(0.7, 0.75, 0.75), wm);
    body.position.y = 0.4; g.add(body);
    
    const head = new THREE.Mesh(new THREE.BoxGeometry(0.55, 0.55, 0.55), wm);
    head.position.y = 0.95; head.position.z = 0.1; g.add(head);
    
    const earGeo = new THREE.BoxGeometry(0.12, 0.55, 0.06);
    const earL = new THREE.Mesh(earGeo, wm);
    earL.position.set(-0.16, 0.45, -0.05); g.add(earL);
    const earR = new THREE.Mesh(earGeo, wm);
    earR.position.set(0.16, 0.45, -0.05); g.add(earR);
    
    const tail = new THREE.Mesh(new THREE.BoxGeometry(0.2, 0.2, 0.2), wm);
    tail.position.set(0, 0.25, -0.4); g.add(tail);
    
    // Ayaklar
    const footGeo = new THREE.BoxGeometry(0.24, 0.16, 0.34);
    const f1 = new THREE.Mesh(footGeo, bm); f1.position.set(-0.32, 0.08, 0.22); g.add(f1);
    const f2 = new THREE.Mesh(footGeo, bm); f2.position.set(0.32, 0.08, 0.22); g.add(f2);
    const f3 = new THREE.Mesh(footGeo, bm); f3.position.set(-0.32, -0.08, -0.22); g.add(f3);
    const f4 = new THREE.Mesh(footGeo, bm); f4.position.set(0.32, -0.08, -0.22); g.add(f4);
...
function createCage(x, z) {
    ...
    // Pamuk heykeli
    const statue = createRabbitStatue();
